...
package net.mcreator.anomalyfoundationmod.world.dimension;
...
import net.mcreator.anomalyfoundationmod.item.AMLdisItem;
...
public class AMLdisDimension extends AnomalyFoundationModModElements.ModElement {
	@ObjectHolder("anomaly_foundation_mod:am_ldis")
	public static final ModDimension dimension = null;
	@ObjectHolder("anomaly_foundation_mod:am_ldis_portal")
	public static final CustomPortalBlock portal = null;
	public static DimensionType type = null;
	private static Biome[] dimensionBiomes;
	public AMLdisDimension(AnomalyFoundationModModElements instance) {
		super(instance, 17);
	...
	public void registerDimension(RegistryEvent.Register<ModDimension> event) {
		event.getRegistry().register(new CustomModDimension().setRegistryName("am_ldis"));
	}

	@SubscribeEvent
	public void onRegisterDimensionsEvent(RegisterDimensionsEvent event) {
		if (DimensionType.byName(new ResourceLocation("anomaly_foundation_mod:am_ldis")) == null) {
			DimensionManager.registerDimension(new ResourceLocation("anomaly_foundation_mod:am_ldis"), dimension, null, true);
		}
		type = DimensionType.byName(new ResourceLocation("anomaly_foundation_mod:am_ldis"));
	}
	...
	public void initElements() {
		...
		elements.items.add(() -> new AMLdisItem().setRegistryName("am_ldis"));
	}
	...
	public static class CustomPortalBlock extends NetherPortalBlock {
		public CustomPortalBlock() {
			...
			setRegistryName("am_ldis_portal");
		}
		...
		private TeleporterDimensionMod getTeleporterForDimension(Entity entity, BlockPos pos, ServerWorld nextWorld) {
			BlockPattern.PatternHelper bph = AMLdisDimension.CustomPortalBlock.createPatternHelper(entity.world, pos);
	...
	public static final TicketType<BlockPos> CUSTOM_PORTAL = TicketType.create("am_ldis_portal", Vec3i::compareTo, 300);
	@SubscribeEvent
	public void registerPointOfInterest(RegistryEvent.Register<PointOfInterestType> event) {
		try {
			...
			poi = (PointOfInterestType) method.invoke(null, "am_ldis_portal",
	...
	public static class TeleporterDimensionMod implements ITeleporter {
		...
		public BlockPattern.PortalInfo placeInExistingPortal(BlockPos p_222272_1_, Vec3d p_222272_2_, Direction directionIn, double p_222272_4_,
			...
			return optional.map((p_226707_7_) -> {
				...
				BlockPattern.PatternHelper blockpattern$patternhelper = AMLdisDimension.CustomPortalBlock.createPatternHelper(this.world, blockpos);
		...
		public ChunkProviderModded(IWorld world, BiomeProvider provider) {
			super(world, provider, new OverworldGenSettings() {
				public BlockState getDefaultBlock() {
					return UnknownSourceBlock.block.getDefaultState();
				}
			...
			if (!biomesPatched) {
				for (Biome biome : this.biomes) {
					biome.addCarver(GenerationStage.Carving.AIR, Biome.createCarver(new CaveWorldCarver(ProbabilityConfig::deserialize, 256) {
						{
							carvableBlocks = ImmutableSet.of(UnknownSourceBlock.block.getDefaultState().getBlock(),
