...
public class UnknounSourcesItem extends AnomalyFoundationModModElements.ModElement {
	@ObjectHolder("anomaly_foundation_mod:unknoun_sources")
	public static final Item block = null;
	public UnknounSourcesItem(AnomalyFoundationModModElements instance) {
		super(instance, 18);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("unknoun_sources");
		}
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Too Grassy."));
		}
	}
}
