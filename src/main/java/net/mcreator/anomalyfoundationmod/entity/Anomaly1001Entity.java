...
public class Anomaly1001Entity extends AnomalyFoundationModModElements.ModElement {
	public static EntityType entity = null;
	public Anomaly1001Entity(AnomalyFoundationModModElements instance) {
		super(instance, 12);
	...
	public void initElements() {
		entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.WATER_CREATURE)
				...
				.size(0.6f, 1.8f)).build("anomaly_1001").setRegistryName("anomaly_1001");
		elements.entities.add(() -> entity);
		elements.items.add(() -> new SpawnEggItem(entity, -13421569, -16724737, new Item.Properties().group(AnomlItemGroup.tab))
				.setRegistryName("anomaly_1001"));
	}
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			if (!biomeCriteria)
				continue;
			biome.getSpawns(EntityClassification.WATER_CREATURE).add(new Biome.SpawnListEntry(entity, 20, 2, 4));
		}
		...
		RenderingRegistry.registerEntityRenderingHandler(entity, renderManager -> {
			BipedRenderer customRender = new BipedRenderer(renderManager, new BipedModel(0), 0.5f) {
				...
				public ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("anomaly_foundation_mod:textures/anomaly_1001.png");
				}
			};
	...
	public static class CustomEntity extends ZombieEntity {
		...
		protected void dropSpecialItems(DamageSource source, int looting, boolean recentlyHitIn) {
			...
			this.entityDropItem(new ItemStack(Items.WATER_BUCKET, (int) (1)));
		}
