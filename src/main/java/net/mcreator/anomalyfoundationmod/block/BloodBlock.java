...
public class BloodBlock extends AnomalyFoundationModModElements.ModElement {
	@ObjectHolder("anomaly_foundation_mod:blood")
	public static final FlowingFluidBlock block = null;
	@ObjectHolder("anomaly_foundation_mod:blood_bucket")
	public static final Item bucket = null;
	public static FlowingFluid flowing = null;
	public static FlowingFluid still = null;
	private ForgeFlowingFluid.Properties fluidproperties = null;
	public BloodBlock(AnomalyFoundationModModElements instance) {
		super(instance, 19);
	...
	public void initElements() {
		fluidproperties = new ForgeFlowingFluid.Properties(() -> still, () -> flowing,
				FluidAttributes.builder(new ResourceLocation("anomaly_foundation_mod:blocks/blod_sill"),
						new ResourceLocation("anomaly_foundation_mod:blocks/blod_flw")).luminosity(10).density(1000).viscosity(1000))
		...
		elements.items.add(() -> new BucketItem(still, new Item.Properties().containerItem(Items.BUCKET).maxStackSize(1).group(AnomlItemGroup.tab))
		...
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			biome.addFeature(GenerationStage.Decoration.LOCAL_MODIFICATIONS, new LakesFeature(BlockStateFeatureConfig::deserialize) {
				...
				public boolean place(IWorld world, ChunkGenerator generator, Random rand, BlockPos pos, BlockStateFeatureConfig config) {
					...
					if (dimensionType == AMLdisDimension.type)
						dimensionCriteria = true;
